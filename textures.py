...
class UfilesTextures:  # Clase principal de las texturas
    ...
    def __init__(self, lang=["Cargando textura '%.gif' ...", "ok"]):  # Función constructora
        ...
        # iconos
        "actualizacion": FOLDER_ICONS + "actualizacion.ico", \
        "application_error": FOLDER_ICONS + "application_error.ico", \
        "configuration": FOLDER_ICONS + "configuration.ico", \
        ...
        # imagenes
        "box_curso": PhotoImage(file=FOLDER_SPRITES + "box_curso_2.gif"), \
        ...
        "notas": PhotoImage(file=FOLDER_SPRITES + "notas.gif"), \
